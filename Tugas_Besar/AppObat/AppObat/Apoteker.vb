...
Public Class Apoteker
    Private Sub TambahData()
        ...
        Dim postData As String = $"nip={nip}&nama={nama}&jk={jk}&nohp={nohp}"
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(apoteker_api, "POST", byteArray)
    ...
    Private Sub UpdateData()
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(apoteker_api & "?nip=" & txtNIP.Text, "PUT", byteArray)
    ...
    Private Sub DeleteData()
        ...
        Try
            ...
            ' Send the PUT request and get the response
            Dim responseBytes As Byte() = client.UploadData(apoteker_api & "?nip=" & txtNIP.Text, "DELETE", byteArray)
    ...
    Private Sub GetData()
        Using client As New HttpClient()
            ...
            Dim response As HttpResponseMessage = client.GetAsync(apoteker_api & "?nip=" & txtNIP.Text).Result
            ...
            If response.IsSuccessStatusCode Then
                ...
                Finally
                    If (apoteker_baru = False) Then
                        ' Deserialize the JSON into objects
                        Dim data As List(Of Apoteker1) = JsonConvert.DeserializeObject(Of List(Of Apoteker1))(jsonString)

                        ' Create textboxes dynamically and set their values
                        For Each mydata As Apoteker1 In data
                            txtNIP.Text = mydata.nip
                            txtNama.Text = mydata.nama
                            txtJK.Text = mydata.jk
                            txtNohp.Text = mydata.nohp
                        Next
                    End If
    ...
    Private Sub Reloaded()
        ...
        Dim response As String = client.DownloadString(apoteker_api)

        ' Deserialize the JSON response into a list of objects
        Dim data As List(Of Apoteker1) = JsonConvert.DeserializeObject(Of List(Of Apoteker1))(response)
