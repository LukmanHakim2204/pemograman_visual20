...
Public Class Customer1
    Private Sub TambahData()
        ...
        Dim kdcustomer As String = txtKode.Text
        Dim nama As String = txtNama.Text
        Dim jk As String = txtJK.Text
        Dim email As String = txtEmail.Text

        Dim postData As String = $"kdcustomer={kdcustomer}&nama={nama}&jk={jk}&email={email}"
    ...
    Private Sub UpdateData()
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(customer_api & "?kdcustomer=" & txtKode.Text, "PUT", byteArray)
    ...
    Private Sub DeleteData()
        ...
        Try
            ...
            ' Send the PUT request and get the response
            Dim responseBytes As Byte() = client.UploadData(customer_api & "?kdcustomer=" & txtKode.Text, "DELETE", byteArray)
